...
<template>
    ...
    <aside class="app-sidebar w-64 bg-white flex flex-col items-center py-8 px-4 fixed h-full border-r border-gray-100 z-20" :class="{ open: isOpen }">
        ...
        <nav class="w-full space-y-3 flex flex-col items-center" @click="closeSidebar">
            ...
            <RouterLink to="/pengajuan" class="w-full flex items-center gap-3 px-3 py-2 text-gray-500 hover:text-blue-900 font-semibold transition-colors" active-class="text-gray-800 font-bold">
            ...
            <RouterLink v-if="['Manager','HRD'].includes(user.role)" to="/persetujuan" class="w-full flex items-center gap-3 px-3 py-2 text-gray-500 hover:text-blue-900 font-semibold transition-colors" active-class="text-gray-800 font-bold">
            ...
            <RouterLink v-if="user.role === 'HRD'" to="/data-karyawan" class="w-full flex items-center gap-3 px-3 py-2 text-gray-500 hover:text-blue-900 font-semibold transition-colors" active-class="text-gray-800 font-bold">
                <svg class="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                <span class="text-base">Data Karyawan</span>
            </RouterLink>

            <RouterLink v-if="user.role === 'HRD'" to="/laporan" class="w-full flex items-center gap-3 px-3 py-2 text-gray-500 hover:text-blue-900 font-semibold transition-colors" active-class="text-gray-800 font-bold">
            ...
            <RouterLink to="/ganti-password" class="w-full flex items-center gap-3 px-3 py-2 text-gray-500 hover:text-blue-900 font-semibold transition-colors" active-class="text-gray-800 font-bold">
